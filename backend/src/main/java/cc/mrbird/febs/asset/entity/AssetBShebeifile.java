...
@Excel("asset_b_shebeifile")
@Data
public class AssetBShebeifile implements Serializable{
...
private static final long serialVersionUID=1L;
     ...
     */
        ...
        @ExcelField(value ="上传日期", writeConverter = DateConverter.class,readConverter = DateReadConverter.class)
    private Date scDate;
    private transient String scDateFrom;
    private transient String scDateTo;
