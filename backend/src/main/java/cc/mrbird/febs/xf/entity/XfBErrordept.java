...
@Excel("xf_b_errordept")
@Data
public class XfBErrordept implements Serializable{
...
private static final long serialVersionUID=1L;
     ...
     */
        ...
        @ExcelField(value ="反馈日期", writeConverter = DateConverter.class,readConverter = DateReadConverter.class)
    private Date feedbackDate;
    private transient String feedbackDateFrom;
    private transient String feedbackDateTo;

    /**
     * 反馈人
     */
        
        @ExcelField(value ="反馈人")
