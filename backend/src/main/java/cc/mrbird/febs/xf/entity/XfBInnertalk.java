...
@Excel("xf_b_innertalk")
@Data
public class XfBInnertalk implements Serializable{
...
private static final long serialVersionUID=1L;
     ...
     */
        ...
        @ExcelField(value ="谈话日期", writeConverter = DateConverter.class,readConverter = DateReadConverter.class)
    private Date talkDate;
    private transient String talkDateFrom;
    private transient String talkDateTo;

    /**
     * 谈话缘由
     */
        
        @ExcelField(value ="谈话缘由")
