...
@Excel("xf_b_projectreport")
@Data
public class XfBProjectreport implements Serializable{
...
private static final long serialVersionUID=1L;
     ...
     */
        ...
        @ExcelField(value ="汇报时间", writeConverter = DateConverter.class,readConverter = DateReadConverter.class)
