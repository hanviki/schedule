...
@Excel("xf_b_reportrecord")
@Data
public class XfBReportrecord implements Serializable{
...
private static final long serialVersionUID=1L;
     ...
     */
        ...
        @ExcelField(value ="报告日期", writeConverter = DateConverter.class,readConverter = DateReadConverter.class)
    private Date reportDate;
    private transient String reportDateFrom;
    private transient String reportDateTo;
