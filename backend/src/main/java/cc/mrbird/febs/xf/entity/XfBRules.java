...
@Excel("xf_b_rules")
@Data
public class XfBRules implements Serializable{
...
private static final long serialVersionUID=1L;
    ...
    private Date reordDate;
    private transient String reordDateFrom;
    private transient String reordDateTo;
    ...
    public static final String REORD_DATE ="reord_date" ;
