...
@Excel("xf_b_teachrecord")
@Data
public class XfBTeachrecord implements Serializable{
...
private static final long serialVersionUID=1L;
     ...
     */
        ...
        @ExcelField(value ="宣教日期", writeConverter = DateConverter.class,readConverter = DateReadConverter.class)
