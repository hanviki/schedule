...
@Excel("xf_b_tousu")
@Data
public class XfBTousu implements Serializable{
...
private static final long serialVersionUID=1L;
     ...
     */
        ...
        @ExcelField(value ="投诉日期", writeConverter = DateConverter.class,readConverter = DateReadConverter.class)
    private Date tousuDate;
    private transient String tousuDateFrom;
    private transient String tousuDateTo;
     ...
     */
        ...
        @ExcelField(value ="接受日期", writeConverter = DateConverter.class,readConverter = DateReadConverter.class)
     ...
     */
        ...
        @ExcelField(value ="处理结果")
    private String redult;

    /**
     * 领导小组意见
     */
        
        @ExcelField(value ="领导小组意见")
    ...
    public static final String TOUSU_DATE ="tousu_date" ;
    ...
    public static final String REDULT ="redult" ;
