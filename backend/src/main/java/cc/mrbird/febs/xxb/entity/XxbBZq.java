...
public class XxbBZq implements Serializable{
...
private static final long serialVersionUID=1L;
     ...
     */
        ...
        @ExcelField(value ="延期时间", writeConverter = DateConverter.class,readConverter = DateReadConverter.class)
    private Date yqDate;
    ...
    private  transient  String yzDateStr;
