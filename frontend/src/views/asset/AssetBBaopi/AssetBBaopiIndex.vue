<template>
    <a-card title="">
      ...
      <template
          ...
          <div v-else>
              <a-textarea
                      @blur="e => inputChange(e.target.value,record,'type')"
                      :value="record.type"
              >
              </a-textarea>
          </div>
      ...
      <template
          ...
          <div v-else>
              <a-textarea
                      @blur="e => inputChange(e.target.value,record,'bh')"
                      :value="record.bh"
              >
              </a-textarea>
          </div>
            ...
            >
                ...
                <div v-else>
                    <a-date-picker
                            ...
                            @change="(e,f) => handleChange(e,f,record,'baopiDate')"
                    />
                </div>
            </template>
      <template
...
<script>
   ...
   if(         element.baseId!= ''       ||    element.type!= ''       ||    element.lb!= ''       ||    element.bh!= ''       ||    element.baopiDate!= ''       ||    element.fileId!= ''       ||    element.fileUrl!= ''          ||    element.note!= ''                     ){
        ...
        computed: {
            ...
            return [                        {
                        ...
                        },
                        {
                            ...
                            dataIndex: 'bh',
                            width: 130,
                            scopedSlots: { customRender: 'bh' }
                        },
                        {
                                title: '报批时间',
                            dataIndex: 'baopiDate',
                            width: 130,
                            scopedSlots: { customRender: 'baopiDate' }
                        },
                        {
                                title: '附件ID',
                            dataIndex: 'fileId',
