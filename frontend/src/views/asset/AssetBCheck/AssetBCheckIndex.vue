<template>
    <a-card title="">
      ...
      <template
          ...
          <div v-else>
              <a-textarea
                      @blur="e => inputChange(e.target.value,record,'checkType')"
      ...
      <template
          ...
          <div v-else>
              <a-textarea
                      @blur="e => inputChange(e.target.value,record,'checkNo')"
                      :value="record.checkNo"
              >
              </a-textarea>
          </div>
            </template>
      ...
      <template
          ...
          <div v-else>
              <a-textarea
                      @blur="e => inputChange(e.target.value,record,'checkResult')"
      ...
      <template
          ...
          <div v-else>
              <a-textarea
                      @blur="e => inputChange(e.target.value,record,'checkCs')"
                      :value="record.checkCs"
              >
              </a-textarea>
          </div>
            </template>
...
<script>
   ...
   if(         element.baseId!= ''       ||    element.checkType!= ''       ||    element.checkNo!= ''       ||    element.checkDate!= ''       ||    element.checkResult!= ''          ||    element.note!= ''       ||    element.checkCs!= ''                     ){
        ...
        computed: {
            ...
            return [                        {
                        ...
                        },
                        {
                            ...
                            dataIndex: 'checkCs',
                            width: 130,
                            scopedSlots: { customRender: 'checkCs' }
                        },
                {
                    title: '状态',
                    dataIndex: 'state',
