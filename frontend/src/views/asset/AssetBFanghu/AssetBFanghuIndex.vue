<template>
    <a-card title="">
        ...
        >
            ...
            <div v-else>
                <a-input-number
                        @blur="e => inputChange(e.target.value,record,'baseId')"
                        :value="record.baseId"
                        :precision="0"
                >
                </a-input-number>
      ...
      <template
          ...
          <div v-else>
              <a-textarea
                      @blur="e => inputChange(e.target.value,record,'lb')"
                      :value="record.lb"
              >
              </a-textarea>
          </div>
      ...
      <template
          ...
          <div v-else>
              <a-textarea
                      @blur="e => inputChange(e.target.value,record,'ypfzfh')"
                      :value="record.ypfzfh"
              >
              </a-textarea>
          </div>
        ...
        >
            ...
            <div v-else>
                <a-input-number
                        @blur="e => inputChange(e.target.value,record,'shuliang')"
                        :value="record.shuliang"
                        :precision="0"
                >
                </a-input-number>
            </div>
      ...
      <template
          ...
          <div v-else>
              <a-textarea
                      @blur="e => inputChange(e.target.value,record,'qiandangliang')"
                      :value="record.qiandangliang"
              >
              </a-textarea>
          </div>
            </template>
            ...
            >
                ...
                <div v-else>
                    <a-date-picker
                            ...
                            @change="(e,f) => handleChange(e,f,record,'chuchangDate')"
                    />
                </div>
            </template>
      <template
...
<script>
   ...
   if(         element.baseId!= ''       ||    element.lb!= ''       ||    element.ypfzfh!= ''       ||    element.shuliang!= ''       ||    element.qiandangliang!= ''       ||    element.chuchangDate!= ''          ||    element.note!= ''                     ){
   ...
   if(         element.baseId!= ''       ||    element.lb!= ''       ||    element.ypfzfh!= ''       ||    element.shuliang!= ''       ||    element.qiandangliang!= ''       ||    element.chuchangDate!= ''          ||    element.note!= ''                     ){
        ...
        computed: {
            ...
            return [                        {
                            ...
                            dataIndex: 'baseId',
                            width: 130,
                            scopedSlots: { customRender: 'baseId' }
                        },
                        {
                                title: '类别',
                            dataIndex: 'lb',
                            width: 130,
                            scopedSlots: { customRender: 'lb' }
                        },
                        {
                                title: '用品及辅助防护设施',
                            dataIndex: 'ypfzfh',
                            width: 130,
                            scopedSlots: { customRender: 'ypfzfh' }
                        },
                        {
                                title: '数量',
                            dataIndex: 'shuliang',
                        ...
                        },
                        {
                            ...
                            width: 130,
                            scopedSlots: { customRender: 'qiandangliang' }
                        },
                        {
                                title: '出场日期',
                            dataIndex: 'chuchangDate',
                            width: 130,
                            scopedSlots: { customRender: 'chuchangDate' }
                        },
                        {
                                title: '备注',
                            dataIndex: 'note',
