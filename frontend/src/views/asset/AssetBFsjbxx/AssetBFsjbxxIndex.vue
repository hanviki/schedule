<template>
    <a-card title="">
            ...
            >
                ...
                <div v-else>
                    <a-date-picker
                            ...
                            @change="(e,f) => handleChange(e,f,record,'createDate')"
                    />
                </div>
            </template>
      <template
      ...
      <template
          ...
          <div v-else>
              <a-textarea
                      @blur="e => inputChange(e.target.value,record,'hsmc')"
                      :value="record.hsmc"
              >
              </a-textarea>
          </div>
      ...
      <template
          ...
          <div v-else>
              <a-textarea
                      @blur="e => inputChange(e.target.value,record,'meishu')"
                      :value="record.meishu"
              >
              </a-textarea>
          </div>
      ...
      <template
          ...
          <div v-else>
              <a-textarea
                      @blur="e => inputChange(e.target.value,record,'zhd')"
                      :value="record.zhd"
              >
              </a-textarea>
          </div>
...
<script>
   ...
   if(         element.baseId!= ''       ||    element.createDate!= ''       ||    element.lb!= ''       ||    element.hsmc!= ''       ||    element.meishu!= ''       ||    element.zhd!= ''          ||    element.note!= ''                     ){
        ...
        computed: {
            ...
            return [                        {
                        ...
                        },
                        {
                            ...
                            dataIndex: 'hsmc',
                            width: 130,
                            scopedSlots: { customRender: 'hsmc' }
                        },
                        {
                                title: '枚数',
                            dataIndex: 'meishu',
                            width: 130,
                            scopedSlots: { customRender: 'meishu' }
                        },
                        {
                                title: '总活度',
                            dataIndex: 'zhd',
                            width: 130,
                            scopedSlots: { customRender: 'zhd' }
                        },
                        {
                                title: '备注',
                            dataIndex: 'note',
