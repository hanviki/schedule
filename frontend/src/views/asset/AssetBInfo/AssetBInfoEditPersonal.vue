<template>
  ...
  <a-card title="设备基本信息" :bordered="true"  class="card-area" head-style="font-weight:bold;color:Brown;">
    ...
    <asset-b-state :viewVisiable="viewVisiable" :baseId="assetBInfo.id" :isEdit="0" ></asset-b-state>
    <asset-b-check :viewVisiable="viewVisiable" :baseId="assetBInfo.id" :isEdit="0"></asset-b-check>
    <asset-b-baopi :viewVisiable="viewVisiable" :baseId="assetBInfo.id" :isEdit="0"></asset-b-baopi>
    ...
    <asset-b-fsjbxx :viewVisiable="viewVisiable" :baseId="assetBInfo.id" :isEdit="0"></asset-b-fsjbxx>
    <asset-b-shebeifile :viewVisiable="viewVisiable" :baseId="assetBInfo.id" :isEdit="0"></asset-b-shebeifile>
...
import UploadSingleFile from "../../common/uploadSingleFileReadonly";
