<template>
    <a-card title="">
      ...
      <template
          ...
          <div v-else>
              <a-textarea
                      @blur="e => inputChange(e.target.value,record,'assetState')"
                      :value="record.assetState"
              >
              </a-textarea>
          </div>
            </template>
            ...
            >
                ...
                <div v-else>
                    <a-date-picker
                            ...
                            @change="(e,f) => handleChange(e,f,record,'operationDate')"
                    />
                </div>
            </template>
      <template
...
<script>
   ...
   if(         element.baseId!= ''       ||    element.assetState!= ''       ||    element.operationDate!= ''          ||    element.note!= ''                     ){
        ...
        computed: {
            ...
            return [                        {
                        ...
                        },
                        {
                            ...
                            width: 130,
                            scopedSlots: { customRender: 'assetState' }
                        },
                        {
                                title: '操作时间',
