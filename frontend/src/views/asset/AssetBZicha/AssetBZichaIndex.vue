            ...
            >
                ...
                <div v-else>
                    <a-date-picker
                            ...
                            @change="(e,f) => handleChange(e,f,record,'zichaDate')"
                    />
                </div>
            </template>
      <template
...
<script>
   ...
   if(         element.baseId!= ''       ||    element.zichaDate!= ''       ||    element.fileId!= ''       ||    element.fileUrl!= ''          ||    element.note!= ''                     ){
        ...
        computed: {
            ...
            return [                        {
                        ...
                        },
                        {
                            ...
                            dataIndex: 'zichaDate',
                            width: 130,
                            scopedSlots: { customRender: 'zichaDate' }
                        },
                        {
                                title: '附件ID',
                            dataIndex: 'fileId',
