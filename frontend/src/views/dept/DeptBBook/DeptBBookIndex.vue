<template>
    <a-card title="">
      ...
      <template
          ...
          <div v-else>
              <a-textarea
                      @blur="e => inputChange(e.target.value,record,'bookName')"
            ...
            >
                ...
                <div v-else>
                    <a-date-picker
                            ...
                            @change="(e,f) => handleChange(e,f,record,'bookDate')"
                    />
                </div>
            </template>
      <template
...
<script>
   ...
   if(         element.userAccount!= ''       ||    element.userAccountName!= ''       ||    element.bookType!= ''       ||    element.bookName!= ''       ||    element.bookNo!= ''       ||    element.bookDate!= ''          ||    element.note!= ''                         ||    element.fileId!= ''       ||    element.fileUrl!= ''   ){
        ...
        computed: {
            ...
            return [                        {
                        ...
                        },
                        {
                            ...
                            dataIndex: 'bookDate',
                            width: 130,
                            scopedSlots: { customRender: 'bookDate' }
                        },
                        {
                                title: '备注',
                            dataIndex: 'note',
