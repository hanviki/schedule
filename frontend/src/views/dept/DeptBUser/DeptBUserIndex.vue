    ...
    <a-card title="">
      ...
      <template
        ...
        >
            ...
            <div v-else>
                <a-input-number
                        @blur="e => inputChange(e.target.value,record,'fsgl')"
                        :value="record.fsgl"
                        :precision="0"
                >
                </a-input-number>
            ...
            >
                ...
                <div v-else>
                    <a-date-picker
                            ...
                            @change="(e,f) => handleChange(e,f,record,'workDate')"
                    />
                </div>
            </template>
      <template
      ...
      <template
          ...
          <div v-else>
              <a-textarea
                      @blur="e => inputChange(e.target.value,record,'deptId')"
                      :value="record.deptId"
              >
              </a-textarea>
          </div>
...
<script>
   ...
   if(         element.userAccountName!= ''       ||    element.userAccount!= ''       ||    element.yuanqu!= ''       ||    element.fsgl!= ''       ||    element.workDate!= ''       ||    element.deptName!= ''       ||    element.deptId!= ''       ||    element.fileId!= ''       ||    element.fileUrl!= ''                            ||    element.note!= ''   ){
