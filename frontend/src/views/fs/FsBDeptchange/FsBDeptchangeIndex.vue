...
export default {
  ...
  methods: {
    ...
    batchDelete() {
      ...
      this.$confirm({
        ...
        onOk() {
          ...
          that.$delete("fsBDeptchange/" + sdlBDeptchangeIds).then(() => {
    ...
    exportExcel() {
      ...
      this.$export("fsBDeptchange/excel", {
        sortField: sortField,
        sortOrder: sortOrder,
        ...this.queryParams,
      });
    ...
    fetch(params = {}) {
      ...
      params.userDept= this.$store.state.account.user.deptId
      this.$get("fsBDeptchange", {
        ...params,
      }).then((r) => {
        let data = r.data;
