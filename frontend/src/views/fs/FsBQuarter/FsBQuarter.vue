    ...
    <div>
      <div class="operator">
        ...
        <import-excel
          ...
          templateUrl="fsBQuarter/downTemplate"
          @succ="handleRefesh"
          url="fsBQuarter/import"
        >
        </import-excel>
      </div>
      <!-- 表格区域 -->
...
<script>
import FsBQuarterAdd from "./FsBQuarterAdd";
import FsBQuarterEdit from "./FsBQuarterEdit";
...
export default {
  name: "FsBQuarter",
  components: { FsBQuarterAdd, FsBQuarterEdit, ImportExcel },
  data() {
    return {
      advanced: false,
      dataSource: [],
  ...
  methods: {
    ...
    batchDelete() {
      ...
      this.$confirm({
        ...
        centered: true,
        onOk() {
          let fsBQuarterIds = that.selectedRowKeys.join(",");
          that.$delete("fsBQuarter/" + fsBQuarterIds).then(() => {
