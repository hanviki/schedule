  ...
  >
    <a-form :form="form">
      ...
      <a-form-item v-bind="formItemLayout" label="季度">
        ...
        >
          <a-select-option :value="1" :key="1"> 1</a-select-option>
          <a-select-option :value="2" :key="2"> 2</a-select-option>
          <a-select-option :value="3" :key="3"> 3</a-select-option>
          <a-select-option :value="4" :key="4"> 4</a-select-option>
        </a-select>
      </a-form-item>
...
export default {
  ...
  methods: {
    ...
    setFormValues({ ...fsBQuarter }) {
      let fields = ["year", "quarter", "number"];
      let fieldDates = [];
