    ...
    <a-card title="">
      ...
      <template
        ...
        >
            ...
            <div v-else>
                <a-input-number
                        @blur="e => inputChange(e.target.value,record,'quarter')"
      ...
      <template
          ...
          <div v-else>
              <a-textarea
                      @blur="e => inputChange(e.target.value,record,'number')"
                      :value="record.number"
              >
              </a-textarea>
          </div>
...
<script>
   ...
   if(         element.year!= ''       ||    element.quarter!= ''       ||    element.number!= ''                        ){
