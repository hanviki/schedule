    ...
    <div>
      <div class="operator">
        ...
        <import-excel
          ...
          templateUrl="fsBQuarterD/downTemplate"
          @succ="handleRefesh"
          url="fsBQuarterD/import"
        >
        </import-excel>
      </div>
      <!-- 表格区域 -->
...
<script>
import FsBQuarterDAdd from "./FsBQuarterDAdd";
import FsBQuarterDEdit from "./FsBQuarterDEdit";
...
export default {
  name: "FsBQuarterD",
  components: { FsBQuarterDAdd, FsBQuarterDEdit, ImportExcel },
  data() {
    return {
      advanced: false,
      dataSource: [],
  ...
  methods: {
    ...
    edit(record) {
      this.$refs.fsBQuarterDEdit.setFormValues(record);
