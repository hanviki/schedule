<template>
  <a-card :bordered="true" title="监测信息" class="card-area" head-style="font-weight:bold;color:gold;">
    ...
    <div>
      <div class="operator">
        ...
        <!-- <import-excel
          v-hasPermission="['fsBRecord:import']"
          templateUrl="fsBRecord/downTemplate"
          @succ="handleRefesh"
          url="fsBRecord/import"
        >
        </import-excel> -->
      </div>
      <!-- 表格区域 -->
...
<script>
import FsBRecordAdd from "./FsBRecordAdd";
import FsBRecordEdit from "./FsBRecordEdit";
...
export default {
  ...
  methods: {
    ...
    edit(record) {
      this.$refs.fsBRecordEdit.setFormValues(record);
    ...
    batchDelete() {
      ...
      this.$confirm({
        ...
        centered: true,
        onOk() {
          let fsBRecordIds = that.selectedRowKeys.join(",");
          that.$delete("fsBRecord/" + fsBRecordIds).then(() => {
