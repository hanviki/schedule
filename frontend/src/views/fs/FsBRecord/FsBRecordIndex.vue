...
<script>
   ...
   if(         element.userAccountName!= ''       ||    element.userAccount!= ''       ||    element.operationDate!= ''          ||    element.note!= ''                     ){
