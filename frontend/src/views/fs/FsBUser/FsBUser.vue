      ...
      <a-form layout="horizontal">
        <a-row>
          <div :class="advanced ? null : 'fold'">
            ...
            <a-col :md="6" :sm="24">
              <a-form-item label="监测状态" v-bind="formItemLayout">
                <a-select v-model="queryParams.jcState" >
                   <a-select-option :value="-1">
                     全部
                   </a-select-option>
                   <a-select-option :value="0">
            ...
            <template v-if="advanced">
              <a-col :md="6" :sm="24">
              <a-form-item label="有无近两年卫生考试" v-bind="formItemLayout">
            ...
            <a-col :md="6" :sm="24">
              <a-form-item label="有无近五年环保考试" v-bind="formItemLayout">
               <a-select v-model="queryParams.isDf5" >
                   <a-select-option value="-1">
                    全部
                </a-select-option>
                <a-select-option value="有">
               ...
               <a-col :md="6" :sm="24">
              <a-form-item label="有无放射工作人员证" v-bind="formItemLayout">
               <a-select v-model="queryParams.isFsz" >
                   <a-select-option value="-1">
                    全部
                </a-select-option>
                <a-select-option value="有">
             ...
             <a-col :md="6" :sm="24">
              <a-form-item label="有无近2年体检记录" v-bind="formItemLayout">
               <a-select v-model="queryParams.isTj" >
                   <a-select-option value="-1">
                    全部
                </a-select-option>
                <a-select-option value="有">
        ...
        },
         {
          ...
          width: 100,
           customRender: (text, row, index) => {
            switch (text) {
              case '有':
                return <a-tag color="green">有</a-tag>;
              case '无':
