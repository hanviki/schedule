    ...
    >
      ...
      >
          ...
          <a-date-picker
            ...
            @change="(e,f) => handleChange4(e,f,record,'startDate')"
          />
      </template>
       <template
        slot="endDate"
      ...
      >
          ...
          <a-date-picker
            :defaultValue="(text=='' || text==null)?'':moment(text, dateFormat)"
            @change="(e,f) => handleChange4(e,f,record,'endDate')"
          />
      </template>
       <template
        slot="days"
      ...
      >
       <a-input-number
                    style="width:100%;"
                    @blur="e => inputChange5(e.target.value,record,'days')"
                    :value="record.days"
                    :precision="0"
                  >
                  </a-input-number>
...
export default {
  ...
  methods: {
    ...
    getFieldValues() {
     ...
     handleChange4 (date, dateStr, record, filedName) {
      const value = dateStr
      record[filedName] = value
    },
    inputChange5 (value, record, filedName) {
      console.info(value)
      record[filedName] = value
    },
    fetch() {
