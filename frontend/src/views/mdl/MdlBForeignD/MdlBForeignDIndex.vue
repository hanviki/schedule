...
<script>
   ...
   if(         element.baseId!= ''       ||    element.userAccountName!= ''       ||    element.userAccount!= ''       ||    element.sexName!= ''       ||    element.birthday!= ''       ||    element.telephone!= ''                     ){
