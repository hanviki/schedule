...
<script>
   ...
   if(         element.baseId!= ''       ||    element.type!= ''       ||    element.userAccountName!= ''       ||    element.userAccount!= ''       ||    element.deptNew!= ''       ||    element.zhicheng!= ''                     ){
