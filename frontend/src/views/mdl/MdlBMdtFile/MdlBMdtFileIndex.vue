<template>
    <a-card title="">
      ...
      <template
          ...
          <div v-else>
              <a-textarea
                      @blur="e => inputChange(e.target.value,record,'zcFileId')"
                      :value="record.zcFileId"
              >
              </a-textarea>
          </div>
            </template>
      <template
          ...
          <div v-else>
              <a-textarea
                      @blur="e => inputChange(e.target.value,record,'zcFileUrl')"
                      :value="record.zcFileUrl"
              >
              </a-textarea>
          </div>
            </template>
...
<script>
   ...
   if(         element.baseId!= ''          ||    element.year!= ''       ||    element.note!= ''       ||    element.fileId!= ''       ||    element.fileUrl!= ''       ||    element.zcFileId!= ''       ||    element.zcFileUrl!= ''                     ){
        ...
        computed: {
            ...
            return [                        {
                        ...
                        },
                        {
                            ...
                            dataIndex: 'zcFileId',
                            width: 130,
                            scopedSlots: { customRender: 'zcFileId' }
                        },
                        {
                                title: '附件2地址',
                            dataIndex: 'zcFileUrl',
                            width: 130,
                            scopedSlots: { customRender: 'zcFileUrl' }
                        },
                {
                    title: '状态',
                    dataIndex: 'state',
