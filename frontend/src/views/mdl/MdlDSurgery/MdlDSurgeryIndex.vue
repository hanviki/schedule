...
<script>
   ...
   if(         element.deptNew!= ''       ||    element.code!= ''       ||    element.name!= ''       ||    element.level!= ''       ||    element.lb!= ''       ||    element.note!= ''                     ){
