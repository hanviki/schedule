<template>
  <a-card title="">
    ...
    >
      ...
      <template slot="talkDate" slot-scope="text, record">
        <div v-if="record.state == 3 || record.state == 1">
        ...
        <div v-else>
          <a-date-picker
            ...
            "
            @change="(e, f) => handleChange(e, f, record, 'talkDate')"
          />
        </div>
      </template>
...
export default {
  ...
  methods: {
    ...
    fetch() {
      this.$get("xfBInnertalk/custom", {}).then((r) => {
        let data = r.data;
    ...
    columns() {
      return [
        ...
        },
        {
          ...
          dataIndex: "talkDate",
          width: 130,
          scopedSlots: { customRender: "talkDate" },
        },
        {
          title: "谈话缘由",
          dataIndex: "content",
