    ...
    <div>
      <div class="operator">
        ...
        <import-excel
          ...
          templateUrl="xfBRules/downTemplate"
          @succ="handleRefesh"
          url="xfBRules/import"
        >
        </import-excel> -->
...
<script>
import XfBRulesAdd from "./XfBRulesAdd";
import XfBRulesEdit from "./XfBRulesEdit";
...
export default {
  name: "XfBRules",
  components: { XfBRulesAdd, XfBRulesEdit },
  data() {
    return {
      advanced: false,
      dataSource: [],
  ...
  methods: {
    ...
    edit(record) {
      this.$refs.xfBRulesEdit.setFormValues(record);
    ...
    batchDelete() {
      ...
      this.$confirm({
        ...
        centered: true,
        onOk() {
          let xfBRulesIds = that.selectedRowKeys.join(",");
          that.$delete("xfBRules/" + xfBRulesIds).then(() => {
