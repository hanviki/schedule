<template>
    <a-card title="">
      ...
      <template
          ...
          <div v-else>
              <a-textarea
                      @blur="e => inputChange(e.target.value,record,'lingyu')"
                      :value="record.lingyu"
              >
              </a-textarea>
          </div>
      ...
      <template
          ...
          <div v-else>
              <a-textarea
                      @blur="e => inputChange(e.target.value,record,'workUnit')"
                      :value="record.workUnit"
              >
              </a-textarea>
          </div>
            </template>
      <template
          ...
          <div v-else>
              <a-textarea
                      @blur="e => inputChange(e.target.value,record,'zw')"
                      :value="record.zw"
              >
              </a-textarea>
          </div>
      ...
      <template
          ...
          <div v-else>
              <a-textarea
                      @blur="e => inputChange(e.target.value,record,'job')"
                      :value="record.job"
              >
              </a-textarea>
          </div>
      ...
      <template
          ...
          <div v-else>
              <a-textarea
                      @blur="e => inputChange(e.target.value,record,'tjbm')"
                      :value="record.tjbm"
              >
              </a-textarea>
          </div>
...
<script>
   ...
   if(         element.userAccountName!= ''       ||    element.userAccount!= ''       ||    element.deptNew!= ''       ||    element.fileId!= ''       ||    element.fileUrl!= ''       ||    element.lingyu!= ''       ||    element.workUnit!= ''       ||    element.zw!= ''       ||    element.job!= ''       ||    element.tjbm!= ''       ||    element.startDate!= ''       ||    element.endDate!= ''       ||    element.remark!= ''                     ){
        ...
        computed: {
            ...
            return [                        {
                        ...
                        },
                        {
                            ...
                            dataIndex: 'lingyu',
                            width: 130,
                            scopedSlots: { customRender: 'lingyu' }
                        },
                        {
                                title: '工作单位',
                            dataIndex: 'workUnit',
