<template>
    <a-card title="">
      ...
      <template
          ...
          <div v-else>
              <a-textarea
                      @blur="e => inputChange(e.target.value,record,'pid')"
                      :value="record.pid"
              >
              </a-textarea>
          </div>
      ...
      <template
          ...
          <div v-else>
              <a-textarea
                      @blur="e => inputChange(e.target.value,record,'flowAccountName')"
                      :value="record.flowAccountName"
              >
              </a-textarea>
          </div>
            </template>
      <template
          ...
          <div v-else>
              <a-textarea
                      @blur="e => inputChange(e.target.value,record,'flowAccount')"
                      :value="record.flowAccount"
              >
              </a-textarea>
          </div>
            </template>
      <template
          ...
          <div v-else>
              <a-textarea
                      @blur="e => inputChange(e.target.value,record,'flowYggh')"
                      :value="record.flowYggh"
              >
              </a-textarea>
          </div>
            </template>
      <template
          ...
          <div v-else>
              <a-textarea
                      @blur="e => inputChange(e.target.value,record,'flowdept')"
                      :value="record.flowdept"
              >
              </a-textarea>
          </div>
            </template>
      <template
          ...
          <div v-else>
              <a-textarea
                      @blur="e => inputChange(e.target.value,record,'flowcontent')"
                      :value="record.flowcontent"
              >
              </a-textarea>
          </div>
            </template>
            ...
            >
                ...
                <div v-else>
                    <a-date-picker
                            ...
                            @change="(e,f) => handleChange(e,f,record,'flowDate')"
                    />
                </div>
            </template>
            <template
...
<script>
   ...
   if(         element.pid!= ''       ||    element.flowAccountName!= ''       ||    element.flowAccount!= ''       ||    element.flowYggh!= ''       ||    element.flowdept!= ''       ||    element.flowcontent!= ''       ||    element.flownum!= ''             ||    element.flowDate!= ''   ){
        ...
        computed: {
            ...
            return [                        {
                        ...
                        },
                        {
                            ...
                            width: 130,
                            scopedSlots: { customRender: 'flowAccountName' }
                        },
                        {
                                title: '人事编号',
                            dataIndex: 'flowAccount',
                            width: 130,
                            scopedSlots: { customRender: 'flowAccount' }
                        },
                        {
                                title: '员工工号',
                            dataIndex: 'flowYggh',
                            width: 130,
                            scopedSlots: { customRender: 'flowYggh' }
                        },
                        {
                                title: '用户科室',
                            dataIndex: 'flowdept',
                            width: 130,
                            scopedSlots: { customRender: 'flowdept' }
                        },
                        {
                                title: '流程内容',
                            dataIndex: 'flowcontent',
                            width: 130,
                            scopedSlots: { customRender: 'flowcontent' }
                        },
                        {
                                title: '流程数',
                            dataIndex: 'flownum',
                            width: 130,
                            scopedSlots: { customRender: 'flownum' }
                        },
                        {
                                title: '审核时间',
                            dataIndex: 'flowDate',
                            width: 130,
                            scopedSlots: { customRender: 'flowDate' }
                        },
                {
                    title: '状态',
                    dataIndex: 'state',
