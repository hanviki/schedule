    ...
    methods: {
        ...
        handleSave() {
            ...
            dataSource.forEach(element => {
                if (element.deptName != '' || element.userAccountName != '' || element.userAccount != '') {
            ...
            if (dataAdd.length === 0) {
                ...
                this.loading = true
                this.$post('xxbBDeptleader/addNew', {
                    jsonStr: jsonStr,
                    state: 0
                }).then(() => {
                    // this.reset()
            ...
            this.$confirm({
                ...
                onOk() {
                    ...
                    if (dataAdd.length === 0) {
                        ...
                        let jsonStr = JSON.stringify(dataAdd)
                        that.loading = true
                        that.$post('xxbBDeptleader/addNew', {
                            jsonStr: jsonStr,
                            state: 1
                        }).then(() => {
                            //this.reset()
        ...
        fetch() {
            this.$get('xxbBDeptleader/custom', {}).then((r) => {
                let data = r.data
