...
import XxbBMqEdit from './XxbBMqEditAudit.vue';
...
export default {
  name: "XxbBFlowDept",
  components: {XxbBMqEdit, XxbBFlow },
  data() {
    return {
      advanced: false,
      dataSource: [],
          ...
          customRender: (text, row, index) => {
            switch (text) {
              ...
              case 6:
                return "项目延期";
              case 7:
                return <a-tag color="green">总结反馈已提交</a-tag>;
              case 8:
                return <a-tag color="red">总结反馈已驳回重填</a-tag>;
              default:
                return text;
            }
          },
  ...
  methods: {
    ...
    fetch(params = {}) {
      ...
      this.$get("xxbBCheck/mqListAudit", {
        ...params,
      }).then((r) => {
        let data = r.data;
