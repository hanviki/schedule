<template>
    <a-card title="">
      ...
      <template
          ...
          <div v-else>
              <a-textarea
                      @blur="e => inputChange(e.target.value,record,'deptAccountName')"
                      :value="record.deptAccountName"
              >
              </a-textarea>
          </div>
            </template>
      <template
          ...
          <div v-else>
              <a-textarea
                      @blur="e => inputChange(e.target.value,record,'deptAccount')"
                      :value="record.deptAccount"
              >
              </a-textarea>
          </div>
            </template>
      <template
          ...
          <div v-else>
              <a-textarea
                      @blur="e => inputChange(e.target.value,record,'deptYggh')"
                      :value="record.deptYggh"
              >
              </a-textarea>
          </div>
            </template>
      <template
        ...
        >
            ...
            <div v-else>
                <a-input-number
                        @blur="e => inputChange(e.target.value,record,'gxd')"
                        :value="record.gxd"
                        :precision="0"
                >
                </a-input-number>
...
<script>
   ...
   if(         element.pid!= ''       ||    element.deptAccountName!= ''       ||    element.deptAccount!= ''       ||    element.deptYggh!= ''       ||    element.deptName!= ''       ||    element.gxd!= ''         ){
        ...
        computed: {
            ...
            return [                        {
                        ...
                        },
                        {
                            ...
                            width: 130,
                            scopedSlots: { customRender: 'deptAccountName' }
                        },
                        {
                                title: '人事编号',
                            dataIndex: 'deptAccount',
                            width: 130,
                            scopedSlots: { customRender: 'deptAccount' }
                        },
                        {
                                title: '员工工号',
                            dataIndex: 'deptYggh',
                            width: 130,
                            scopedSlots: { customRender: 'deptYggh' }
                        },
                        {
                                title: '科室名称',
                            dataIndex: 'deptName',
